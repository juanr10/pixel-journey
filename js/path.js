 ...
 * - Primer paso: desciende desde el centro de la parte inferior de la casa
...
export function computeWaypointsAndPolyline(memories, seed, gridW) {
  ...
  // empuje inicial hacia abajo desde el centro de la parte inferior de la casa
  const startY = HOUSE_ROW + 1;
  polyline.push(cellCenter(HOUSE_COL, HOUSE_ROW));
  polyline.push(cellCenter(curX, startY));
  curY = startY;
